...
const skills = [
  { name: "Git", image: "assets/git_logo.png", bg: "from-orange-500 to-red-600" },
  { name: "Javascript", image: "assets/js_logo.png", bg: "from-yellow-400 to-orange-500" },
  { name: "React", image: "assets/react_logo.png", bg: "from-blue-400 to-cyan-500" },
  { name: "GSAP", image: "assets/gsap.png", bg: "from-green-400 to-emerald-600" },
